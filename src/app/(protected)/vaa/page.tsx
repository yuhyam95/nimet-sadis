...
import { Mountain, RefreshCw, Home, ChevronRight, ArrowLeft } from "lucide-react";
...
const PRODUCT_KEY = "vaa";
const PRODUCT_NAME = "Volcanic Ash Advisory";
        ...
        <header className="w-full flex items-center justify-between">
          <div className="text-center md:text-left">
              <h1 className="text-4xl font-bold text-primary tracking-tight flex items-center">
               <Mountain className="mr-4 h-10 w-10"/> {PRODUCT_NAME}
              </h1>
