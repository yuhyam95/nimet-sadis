...
import { Tornado, RefreshCw, Home, ChevronRight, ArrowLeft } from "lucide-react";
import { Button } from "@/components/ui/button";
import { useToast } from "@/hooks/use-toast";
import { Card, CardContent } from "@/components/ui/card";
import { Skeleton } from "@/components/ui/skeleton";

const PRODUCT_KEY = "tropicalCyclone";
const PRODUCT_NAME = "Tropical Cyclone Data";
      ...
      <header className="w-full max-w-4xl flex items-center justify-between">
        <div className="text-center md:text-left">
          <h1 className="text-4xl font-bold text-primary tracking-tight flex items-center">
            <Tornado className="mr-4 h-10 w-10"/> {PRODUCT_NAME}
          </h1>
